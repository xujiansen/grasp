package com.multi.image.selector;
...
import com.multi.image.selector.adapter.FolderAdapter;
import com.multi.image.selector.adapter.ImageGridAdapter;
import com.multi.image.selector.bean.Folder;
import com.multi.image.selector.bean.Image;
import com.multi.image.selector.utils.FileUtils;
import com.multi.image.selector.utils.TimeUtils;
...
//                }
    ...
    private void showCameraAction() {
        ...
        if (cameraIntent.resolveActivity(getActivity().getPackageManager()) != null) {
            ...
            cameraIntent.putExtra(MediaStore.EXTRA_OUTPUT, FileProvider.getUriForFile(getActivity(), getActivity().getPackageName().concat(".fileProvider"), mTmpFile));
