package com.rooten.frame.page.pagetab;

import android.content.Context;
import android.graphics.Color;
import com.google.android.material.tabs.TabLayout;
import com.rooten.frame.page.pagemanager.MultiPageMgr;
...
public class MultiPageTab extends TabLayout implements MultiPageMgr.onRealizeMultiTab {
    ...
    public void addTab(String title, Map<String, ImageView> mIconMap) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.tablayout_tab_red_dot, null);
