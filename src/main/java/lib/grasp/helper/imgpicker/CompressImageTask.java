package lib.grasp.helper.imgpicker;
...
import com.rooten.util.CompressImageUtil;

import lib.grasp.helper.interf.ImageSingleSelectListener;
...
public class CompressImageTask extends AsyncTask<Void, Void, String> {
    ...
    protected String doInBackground(Void... params) {
        ...
        String mCompressImageURL = CompressImageUtil.compress(CompressImageUtil.AVATAR_IMAGE_SIZE, 100, mAvatarURL, PathUtil.getCompressAvatarPath(), Constant.SUFFIX_AVATAR_NAME);
