...
import com.rooten.frame.widget.RoundImageView;
import lib.grasp.R;
...
public class BannerEntity {
    ...
    public BannerEntity(Context ctx, View view, String title, String url, View.OnClickListener listener, Object object) {
        mView = View.inflate(ctx, R.layout.banner_item, null);
        LinearLayout container = mView.findViewById(R.id.container);
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
        container.addView(view, params);
