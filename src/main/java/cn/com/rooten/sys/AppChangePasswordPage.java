...
import lib.grasp.R;
import cn.com.rooten.frame.TablePage;

public class AppChangePasswordPage extends TablePage {
    private EditText mEdtOldPwd;
    private EditText mEdtNewPwd;
    private EditText mEdtNewPwd2;

    public AppChangePasswordPage(Context context) {
        super(context);
